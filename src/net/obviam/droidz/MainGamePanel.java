...
public class MainGamePanel extends SurfaceView implements
	...
	public MainGamePanel(Context context) {
		...
		droid1 = new Droid(BitmapFactory.decodeResource(getResources(), R.drawable.droid_1), getWidth(), getHeight());
		droid2 = new Droid(BitmapFactory.decodeResource(getResources(), R.drawable.droid_1), getWidth(), getHeight());
